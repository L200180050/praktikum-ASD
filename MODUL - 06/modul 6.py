...
c0 = mahasiswa('Robby', 50, 'Kudus', 300000)
c1 = mahasiswa('Novi', 23, 'Kudus', 200000)
c2 = mahasiswa('Anto', 13, 'Karanganyar', 700000)
c3 = mahasiswa('Bobby', 79, 'Pati', 600000)
c4 = mahasiswa('Djum', 48, 'Rembang', 500000)
c5 = mahasiswa('Djum', 27, 'Demak', 400000)
c6 = mahasiswa('Suyek', 88, 'Jepara', 100000)
c7 = mahasiswa('Togok', 72, 'Semarang', 450000)
c8 = mahasiswa('Dapo', 92, 'Jember', 800000)
c9 = mahasiswa('Keggie', 69, 'Grobogan', 850000)
